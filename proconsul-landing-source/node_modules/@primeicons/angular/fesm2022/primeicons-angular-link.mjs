...
import { link } from '@primeicons/core/link';

class Link extends CoreIcon {
    constructor() {
        super();
        this._icon = link;
    }
...
export { Link };
//# sourceMappingURL=primeicons-angular-link.mjs.map
