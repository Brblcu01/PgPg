...
import { tag } from '@primeicons/core/tag';

class Tag extends CoreIcon {
    constructor() {
        super();
        this._icon = tag;
    }
...
export { Tag };
//# sourceMappingURL=primeicons-angular-tag.mjs.map
