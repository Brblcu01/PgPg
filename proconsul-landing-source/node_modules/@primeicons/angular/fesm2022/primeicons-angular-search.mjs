...
import { search } from '@primeicons/core/search';

class Search extends CoreIcon {
    constructor() {
        super();
        this._icon = search;
    }
...
export { Search };
//# sourceMappingURL=primeicons-angular-search.mjs.map
