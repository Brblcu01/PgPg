...
import { table } from '@primeicons/core/table';

class Table extends CoreIcon {
    constructor() {
        super();
        this._icon = table;
    }
...
export { Table };
//# sourceMappingURL=primeicons-angular-table.mjs.map
