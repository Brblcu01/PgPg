...
import { calendar } from '@primeicons/core/calendar';

class Calendar extends CoreIcon {
    constructor() {
        super();
        this._icon = calendar;
    }
...
export { Calendar };
//# sourceMappingURL=primeicons-angular-calendar.mjs.map
