...
declare class Chip extends BaseComponent<ChipPassThrough> {
    ...
    _label: _angular_core.Signal<string | undefined>;
    ...
    _removable: _angular_core.Signal<boolean>;
    _removeIcon: _angular_core.Signal<string | undefined>;
    removeAriaLabel: _angular_core.Signal<any>;
    removeIconTabindex: _angular_core.Signal<-1 | 0>;
