...
declare const RADIO_VALUE_ACCESSOR: Provider;
...
declare class RadioButton extends BaseEditableHolder<RadioButtonPassThrough> {
    ...
    inputViewChild: _angular_core.Signal<ElementRef<any>>;
    ...
    checked: _angular_core.WritableSignal<Nullable<boolean>>;
...
declare class RadioButtonModule {
    ...
    static ɵmod: _angular_core.ɵɵNgModuleDeclaration<RadioButtonModule, never, [typeof RadioButton, typeof i2.SharedModule], [typeof RadioButton, typeof i2.SharedModule]>;
