...
declare class InputText extends BaseModelHolder<InputTextPassThrough> {
    ...
    static ɵdir: _angular_core.ɵɵDirectiveDeclaration<InputText, "[pInputText]", never, { "hostName": { "alias": "hostName"; "required": false; "isSignal": true; }; "pInputTextPT": { "alias": "pInputTextPT"; "required": false; "isSignal": true; }; "pInputTextUnstyled": { "alias": "pInputTextUnstyled"; "required": false; "isSignal": true; }; "pSize": { "alias": "pSize"; "required": false; "isSignal": true; }; "variant": { "alias": "variant"; "required": false; "isSignal": true; }; "fluid": { "alias": "fluid"; "required": false; "isSignal": true; }; "invalid": { "alias": "invalid"; "required": false; "isSignal": true; }; }, {}, never, never, true, [{ directive: typeof i1.Bind; inputs: {}; outputs: {}; }]>;
}
