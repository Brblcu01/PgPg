 ...
 * @group Components
 */
declare class FloatLabel extends BaseComponent<FloatLabelPassThrough> {
     ...
     * @group Props
     */
    variant: i0.InputSignal<FloatLabelVariant>;
    static ɵfac: i0.ɵɵFactoryDeclaration<FloatLabel, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<FloatLabel, "p-floatlabel, p-float-label", never, { "variant": { "alias": "variant"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, [{ directive: typeof i1.Bind; inputs: {}; outputs: {}; }]>;
}
