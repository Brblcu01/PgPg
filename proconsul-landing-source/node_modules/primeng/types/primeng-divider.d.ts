...
import { DividerPassThrough, DividerLayout, DividerType, DividerAlign } from 'primeng/types/divider';
...
declare class Divider extends BaseComponent<DividerPassThrough> {
     ...
     * @group Props
     */
    layout: i0.InputSignal<DividerLayout>;
    /**
     * Border style type.
     * @group Props
     */
    type: i0.InputSignal<DividerType>;
    /**
     * Alignment of the content.
     * @group Props
     */
    align: i0.InputSignal<DividerAlign | undefined>;
    _componentStyle: DividerStyle;
    dataP: i0.Signal<string | undefined>;
    onAfterViewChecked(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<Divider, never>;
    static ɵcmp: i0.ɵɵComponentDeclaration<Divider, "p-divider", never, { "layout": { "alias": "layout"; "required": false; "isSignal": true; }; "type": { "alias": "type"; "required": false; "isSignal": true; }; "align": { "alias": "align"; "required": false; "isSignal": true; }; }, {}, never, ["*"], true, [{ directive: typeof i1.Bind; inputs: {}; outputs: {}; }]>;
}
