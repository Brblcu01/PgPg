...
import { Injectable, InjectionToken, forwardRef, input, booleanAttribute, output, viewChild, contentChild, signal, inject, computed, effect, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
class CheckboxStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CheckboxStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CheckboxStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CheckboxStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
(function (CheckboxClasses) {
     ...
     */
    CheckboxClasses["indicator"] = "p-checkbox-indicator";
    /**
...
class Checkbox extends BaseEditableHolder {
    ...
    ...(ngDevMode ? [{ debugName: "iconTemplateContext" }] : /* istanbul ignore next */ []));
    dataP = computed(() => {
        return this.cn({
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: Checkbox, decorators: [{
            type: Component,
            args: [{
