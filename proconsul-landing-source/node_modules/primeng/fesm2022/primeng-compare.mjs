...
class CompareStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class CompareHandle extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareHandle, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: CompareHandle, isStandalone: true, selector: "p-compare-handle", host: { listeners: { "pointerdown": "onPointerDown($event)" }, properties: { "class": "cx(\"handle\")", "attr.tabindex": "\"-1\"", "attr.data-orientation": "pcCompare.orientation()", "attr.data-disabled": "pcCompare.dataDisabled()", "attr.data-dragging": "pcCompare.dataDragging()", "style": "handleStyle()" } }, providers: [{ provide: PARENT_INSTANCE, useExisting: CompareHandle }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareHandle, decorators: [{
            type: Component,
            args: [{
...
class CompareIndicator extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareIndicator, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: CompareIndicator, isStandalone: true, selector: "p-compare-indicator", inputs: { ariaLabel: { classPropertyName: "ariaLabel", publicName: "ariaLabel", isSignal: true, isRequired: false, transformFunction: null }, ariaLabelledby: { classPropertyName: "ariaLabelledby", publicName: "ariaLabelledby", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "cx(\"indicator\")", "attr.data-orientation": "pcCompare.orientation()", "attr.data-disabled": "pcCompare.dataDisabled()", "attr.data-dragging": "pcCompare.dataDragging()" } }, providers: [{ provide: PARENT_INSTANCE, useExisting: CompareIndicator }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `
        <input
            type="range"
            [class]="cx('input')"
            [min]="pcCompare.min()"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareIndicator, decorators: [{
            type: Component,
            args: [{
...
class CompareItem extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareItem, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: CompareItem, isStandalone: true, selector: "p-compare-item", inputs: { position: { classPropertyName: "position", publicName: "position", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "cx(\"item\")", "style.position": "\"absolute\"", "style.inset": "\"0\"", "style.clip-path": "clipPath()", "attr.data-position": "position()", "attr.data-orientation": "pcCompare.orientation()", "attr.data-disabled": "pcCompare.dataDisabled()", "attr.data-dragging": "pcCompare.dataDragging()" } }, providers: [{ provide: PARENT_INSTANCE, useExisting: CompareItem }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content></ng-content>`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareItem, decorators: [{
            type: Component,
            args: [{
...
class CompareModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: CompareModule, imports: [Compare, CompareItem, CompareHandle, CompareIndicator, SharedModule, BindModule], exports: [Compare, CompareItem, CompareHandle, CompareIndicator, SharedModule, BindModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareModule, imports: [Compare, CompareItem, CompareHandle, CompareIndicator, SharedModule, BindModule, SharedModule, BindModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: CompareModule, decorators: [{
            type: NgModule,
            args: [{
