...
import { Injectable, InjectionToken, inject, input, booleanAttribute, numberAttribute, signal, computed, contentChild, viewChild, ElementRef, EventEmitter, effect, untracked, HostListener, Inject, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
class ConfirmPopupStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ConfirmPopupStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ConfirmPopupStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ConfirmPopupStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class ConfirmPopup extends BaseComponent {
    ...
    headlessContext = computed(() => ({ $implicit: this.confirmation() }), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "headlessContext" }] : /* istanbul ignore next */ []));
    contentContext = computed(() => ({ $implicit: this.confirmation() }), /* @ts-ignore */
    ...
    handleFocus() {
        ...
        if (focusValue && (this.acceptButtonViewChild() || this.rejectButtonViewChild())) {
            const focusEl = (focusValue === 'accept' ? findSingle(this.acceptButtonViewChild()?.nativeElement, '[data-pc-section="root"]') : findSingle(this.rejectButtonViewChild()?.nativeElement, '[data-pc-section="root"]'));
            focusEl.focus();
        }
    }
    onAfterLeave() {
    ...
    alignArrow() {
        ...
        if (containerOffset && targetOffset && containerOffset.top < targetOffset.top) {
            ...
            !this.$unstyled() && addClass(this.container, 'p-confirmpopup-flipped');
        }
    }
    appendOverlay() {
        ...
        if (!this.documentClickListener) {
            ...
            this.documentClickListener = this.renderer.listen(documentTarget, documentEvent, (event) => {
                ...
                if (confirmation && confirmation.dismissableMask !== false) {
                    let targetElement = confirmation.target;
                    ...
                    <div [pBind]="ptm('footer')" [class]="cx('footer')">
                        @if (rejectVisible) {
                            <button
                                ...
                                [class]="cn(cx('pcRejectButton'), rejectButtonStyleClass)"
                        ...
                        @if (acceptVisible) {
                            <button
                                ...
                                [class]="cn(cx('pcAcceptButton'), acceptButtonStyleClass)"
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ConfirmPopup, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-confirmpopup',
                    standalone: true,
                    imports: [NgTemplateOutlet, SharedModule, ButtonModule, AutoFocus, FocusTrap, Bind, MotionModule],
