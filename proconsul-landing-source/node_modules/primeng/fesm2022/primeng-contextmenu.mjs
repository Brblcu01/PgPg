...
import { InjectionToken, Injectable, input, booleanAttribute, numberAttribute, output, viewChild, signal, computed, inject, ElementRef, Renderer2, effect, ViewEncapsulation, Component, contentChild, ChangeDetectionStrategy, NgModule } from '@angular/core';
...
class ContextMenuStyle extends BaseStyle {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ContextMenuStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ContextMenuStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ContextMenuStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class ContextMenuSub extends BaseComponent {
    ...
    listClass = computed(() => (this.root() ? this.cx('rootList') : this.cx('submenu')), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "listClass" }] : /* istanbul ignore next */ []));
    listPtm = computed(() => this._ptm(this.root() ? 'rootList' : 'submenu'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "listPtm" }] : /* istanbul ignore next */ []));
    listId = computed(() => this.menuId() + '_list', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "listId" }] : /* istanbul ignore next */ []));
    motionState = computed(() => (this.root() ? true : this.visible()), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "motionState" }] : /* istanbul ignore next */ []));
    ...
    contextMenu = inject(CONTEXTMENU_INSTANCE);
    queryMatches() {
    ...
    getAriaSetSize() {
        return this.items()?.filter((processedItem) => this.isItemVisible(processedItem) && !this.getItemProp(processedItem, 'separator')).length ?? 0;
    }
...
class ContextMenu extends BaseComponent {
     ...
     * @group Props
     */
    global = input(false, { ...(ngDevMode ? { debugName: "global" } : /* istanbul ignore next */ {}), transform: booleanAttribute });
    /**
    ...
    getPTOptions(key, item, index, _id) {
        return this.ptm(key, {
            context: {
                item: item,
                index: index,
    ...
    `, isInline: true, dependencies: [{ kind: "component", type: ContextMenuSub, selector: "p-contextmenu-sub", inputs: ["visible", "items", "itemTemplate", "root", "autoZIndex", "baseZIndex", "popup", "menuId", "ariaLabel", "ariaLabelledBy", "level", "focusedItemId", "activeItemPath", "motionOptions", "tabindex"], outputs: ["itemClick", "itemMouseEnter", "menuFocus", "menuBlur", "menuKeydown"] }, { kind: "ngmodule", type: SharedModule }, { kind: "ngmodule", type: BindModule }, { kind: "directive", type: i3.Bind, selector: "[pBind]", inputs: ["pBind"] }, { kind: "ngmodule", type: MotionModule }, { kind: "directive", type: i5.MotionDirective, selector: "[pMotion]", inputs: ["pMotion", "pMotionName", "pMotionType", "pMotionSafe", "pMotionDisabled", "pMotionAppear", "pMotionEnter", "pMotionLeave", "pMotionDuration", "pMotionHideStrategy", "pMotionEnterFromClass", "pMotionEnterToClass", "pMotionEnterActiveClass", "pMotionLeaveFromClass", "pMotionLeaveToClass", "pMotionLeaveActiveClass", "pMotionOptions"], outputs: ["pMotionOnBeforeEnter", "pMotionOnEnter", "pMotionOnAfterEnter", "pMotionOnEnterCancelled", "pMotionOnBeforeLeave", "pMotionOnLeave", "pMotionOnAfterLeave", "pMotionOnLeaveCancelled"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ContextMenu, decorators: [{
            type: Component,
            args: [{
