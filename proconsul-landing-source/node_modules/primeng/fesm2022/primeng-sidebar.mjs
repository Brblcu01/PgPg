...
class SidebarStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class SidebarBackdrop extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarBackdrop, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarBackdrop, isStandalone: true, selector: "p-sidebar-backdrop", host: { listeners: { "click": "onClick($event)" }, properties: { "class": "cx('backdrop')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarBackdrop }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: ``, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarBackdrop, decorators: [{
            type: Component,
            args: [{
...
class SidebarContent extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarContent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarContent, isStandalone: true, selector: "p-sidebar-content", host: { properties: { "class": "cx('content')" } }, providers: [SidebarStyle, { provide: SIDEBAR_CONTENT_INSTANCE, useExisting: SidebarContent }, { provide: PARENT_INSTANCE, useExisting: SidebarContent }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarContent, decorators: [{
            type: Component,
            args: [{
...
class SidebarFooter extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarFooter, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarFooter, isStandalone: true, selector: "p-sidebar-footer", host: { properties: { "class": "cx('footer')" } }, providers: [SidebarStyle, { provide: SIDEBAR_FOOTER_INSTANCE, useExisting: SidebarFooter }, { provide: PARENT_INSTANCE, useExisting: SidebarFooter }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarFooter, decorators: [{
            type: Component,
            args: [{
...
class SidebarGroup extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroup, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarGroup, isStandalone: true, selector: "p-sidebar-group", host: { properties: { "class": "cx('group')" } }, providers: [SidebarStyle, { provide: SIDEBAR_GROUP_INSTANCE, useExisting: SidebarGroup }, { provide: PARENT_INSTANCE, useExisting: SidebarGroup }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroup, decorators: [{
            type: Component,
            args: [{
...
class SidebarGroupAction extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupAction, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "22.0.5", type: SidebarGroupAction, isStandalone: true, selector: "[pSidebarGroupAction]", host: { properties: { "class": "cx('groupAction')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarGroupAction }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupAction, decorators: [{
            type: Directive,
            args: [{
...
class SidebarGroupContent extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupContent, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarGroupContent, isStandalone: true, selector: "p-sidebar-group-content", host: { properties: { "class": "cx('groupContent')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarGroupContent }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupContent, decorators: [{
            type: Component,
            args: [{
...
class SidebarGroupLabel extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupLabel, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarGroupLabel, isStandalone: true, selector: "p-sidebar-group-label", host: { properties: { "class": "cx('groupLabel')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarGroupLabel }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarGroupLabel, decorators: [{
            type: Component,
            args: [{
...
class SidebarHeader extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarHeader, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarHeader, isStandalone: true, selector: "p-sidebar-header", host: { properties: { "class": "cx('header')" } }, providers: [SidebarStyle, { provide: SIDEBAR_HEADER_INSTANCE, useExisting: SidebarHeader }, { provide: PARENT_INSTANCE, useExisting: SidebarHeader }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarHeader, decorators: [{
            type: Component,
            args: [{
...
class SidebarMain extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMain, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarMain, isStandalone: true, selector: "p-sidebar-main", host: { listeners: { "click": "onClick($event)" }, properties: { "class": "cx('main')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarMain }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMain, decorators: [{
            type: Component,
            args: [{
...
class SidebarLayout extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarLayout, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarLayout, isStandalone: true, selector: "p-sidebar-layout", host: { properties: { "class": "cx('layout')" } }, providers: [SidebarStyle, { provide: SIDEBAR_LAYOUT_INSTANCE, useExisting: SidebarLayout }, { provide: PARENT_INSTANCE, useExisting: SidebarLayout }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarLayout, decorators: [{
            type: Component,
            args: [{
...
class SidebarMenu extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenu, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarMenu, isStandalone: true, selector: "p-sidebar-menu", host: { attributes: { "role": "list" }, properties: { "class": "cx('menu')" } }, providers: [SidebarStyle, { provide: SIDEBAR_MENU_INSTANCE, useExisting: SidebarMenu }, { provide: PARENT_INSTANCE, useExisting: SidebarMenu }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenu, decorators: [{
            type: Component,
            args: [{
...
class SidebarMenuAction extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuAction, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.0.5", type: SidebarMenuAction, isStandalone: true, selector: "[pSidebarMenuAction]", inputs: { showOnHover: { classPropertyName: "showOnHover", publicName: "showOnHover", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "cx('menuAction')", "attr.data-show-on-hover": "dataShowOnHover()" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarMenuAction }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuAction, decorators: [{
            type: Directive,
            args: [{
...
class SidebarMenuBadge extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuBadge, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarMenuBadge, isStandalone: true, selector: "p-sidebar-menu-badge", host: { properties: { "class": "cx('menuBadge')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarMenuBadge }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuBadge, decorators: [{
            type: Component,
            args: [{
...
class SidebarMenuButton extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuButton, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.0.5", type: SidebarMenuButton, isStandalone: true, selector: "[pSidebarMenuButton]", inputs: { isActive: { classPropertyName: "isActive", publicName: "isActive", isSignal: true, isRequired: false, transformFunction: null } }, host: { listeners: { "click": "onClick($event)" }, properties: { "class": "cx('menuButton')", "attr.data-active": "dataActive()" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarMenuButton }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuButton, decorators: [{
            type: Directive,
            args: [{
...
class SidebarMenuItem extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuItem, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: SidebarMenuItem, isStandalone: true, selector: "p-sidebar-menu-item", inputs: { collapsible: { classPropertyName: "collapsible", publicName: "collapsible", isSignal: true, isRequired: false, transformFunction: null }, open: { classPropertyName: "open", publicName: "open", isSignal: true, isRequired: false, transformFunction: null }, defaultOpen: { classPropertyName: "defaultOpen", publicName: "defaultOpen", isSignal: true, isRequired: false, transformFunction: null }, disabled: { classPropertyName: "disabled", publicName: "disabled", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { open: "openChange" }, host: { attributes: { "role": "listitem" }, properties: { "class": "cx('menuItem')", "attr.data-collapsible": "dataCollapsible()", "attr.data-open": "dataOpen()", "attr.data-disabled": "dataDisabled()" } }, providers: [SidebarStyle, { provide: SIDEBAR_MENU_ITEM_INSTANCE, useExisting: SidebarMenuItem }, { provide: PARENT_INSTANCE, useExisting: SidebarMenuItem }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuItem, decorators: [{
            type: Component,
            args: [{
...
class SidebarMenuSub extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSub, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarMenuSub, isStandalone: true, selector: "p-sidebar-menu-sub", host: { attributes: { "role": "list" }, properties: { "class": "cx('menuSub')" } }, providers: [SidebarStyle, { provide: SIDEBAR_MENU_SUB_INSTANCE, useExisting: SidebarMenuSub }, { provide: PARENT_INSTANCE, useExisting: SidebarMenuSub }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSub, decorators: [{
            type: Component,
            args: [{
...
class SidebarMenuSubButton extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSubButton, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.0.5", type: SidebarMenuSubButton, isStandalone: true, selector: "[pSidebarMenuSubButton]", inputs: { isActive: { classPropertyName: "isActive", publicName: "isActive", isSignal: true, isRequired: false, transformFunction: null }, size: { classPropertyName: "size", publicName: "size", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "class": "cx('menuSubButton')", "attr.data-active": "dataActive()", "attr.data-size": "dataSize()" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarMenuSubButton }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSubButton, decorators: [{
            type: Directive,
            args: [{
        ...
        }], propDecorators: { isActive: [{ type: i0.Input, args: [{ isSignal: true, alias: "isActive", required: false }] }], size: [{ type: i0.Input, args: [{ isSignal: true, alias: "size", required: false }] }] } });

/**
 * SidebarMenuSubItem is a helper component for Sidebar component.
 * @group Components
 */
class SidebarMenuSubItem extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSubItem, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarMenuSubItem, isStandalone: true, selector: "p-sidebar-menu-sub-item", host: { attributes: { "role": "listitem" }, properties: { "class": "cx('menuSubItem')" } }, providers: [SidebarStyle, { provide: SIDEBAR_MENU_SUB_ITEM_INSTANCE, useExisting: SidebarMenuSubItem }, { provide: PARENT_INSTANCE, useExisting: SidebarMenuSubItem }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarMenuSubItem, decorators: [{
            type: Component,
            args: [{
 ...
 * @group Components
 */
class SidebarAside extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarAside, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarAside, isStandalone: true, selector: "p-sidebar-aside", host: { properties: { "class": "cx('aside')" } }, providers: [SidebarStyle, { provide: SIDEBAR_ASIDE_INSTANCE, useExisting: SidebarAside }, { provide: PARENT_INSTANCE, useExisting: SidebarAside }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarAside, decorators: [{
            type: Component,
            args: [{
 ...
 * @group Components
 */
class SidebarPanel extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarPanel, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarPanel, isStandalone: true, selector: "p-sidebar-panel", host: { properties: { "class": "cx('panel')" } }, providers: [SidebarStyle, { provide: SIDEBAR_PANEL_INSTANCE, useExisting: SidebarPanel }, { provide: PARENT_INSTANCE, useExisting: SidebarPanel }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarPanel, decorators: [{
            type: Component,
            args: [{
 ...
 * @group Components
 */
class SidebarRail extends BaseComponent {
    componentName = 'SidebarRail';
    bindDirectiveInstance = inject(Bind, { optional: true, self: true }) ?? undefined;
    _componentStyle = inject(SidebarStyle);
    pcSidebar = inject(SIDEBAR_INSTANCE, { optional: true }) ?? undefined;
    onAfterViewChecked() {
        this.bindDirectiveInstance?.setAttrs(this.ptm('root'));
    }
    onClick(event) {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarRail, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "14.0.0", version: "22.0.5", type: SidebarRail, isStandalone: true, selector: "[pSidebarRail]", host: { attributes: { "aria-label": "Toggle Sidebar", "title": "Toggle Sidebar", "tabindex": "-1", "type": "button" }, listeners: { "click": "onClick($event)" }, properties: { "class": "cx('rail')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarRail }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarRail, decorators: [{
            type: Directive,
            args: [{
 ...
 * @group Components
 */
class SidebarSpacer extends BaseComponent {
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarSpacer, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "14.0.0", version: "22.0.5", type: SidebarSpacer, isStandalone: true, selector: "p-sidebar-spacer", host: { properties: { "class": "cx('spacer')" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarSpacer }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: ``, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarSpacer, decorators: [{
            type: Component,
            args: [{
 ...
 * @group Components
 */
class SidebarTrigger extends BaseComponent {
    componentName = 'SidebarTrigger';
    bindDirectiveInstance = inject(Bind, { optional: true, self: true }) ?? undefined;
    _componentStyle = inject(SidebarStyle);
    layout = inject(SIDEBAR_LAYOUT_INSTANCE, { optional: true });
    ancestorSidebar = inject(SIDEBAR_INSTANCE, { optional: true });
    /**
    ...
    resolveTarget() {
        ...
        if (id)
            return this.layout?.getSidebar(id);
        return this.ancestorSidebar;
    }
    onClick(event) {
        this.resolveTarget()?.toggle(event);
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarTrigger, deps: null, target: i0.ɵɵFactoryTarget.Directive });
    static ɵdir = i0.ɵɵngDeclareDirective({ minVersion: "17.1.0", version: "22.0.5", type: SidebarTrigger, isStandalone: true, selector: "[pSidebarTrigger]", inputs: { target: { classPropertyName: "target", publicName: "target", isSignal: true, isRequired: false, transformFunction: null } }, host: { attributes: { "data-scope": "sidebar", "data-part": "trigger" }, listeners: { "click": "onClick($event)" }, properties: { "class": "cx('trigger')", "attr.aria-controls": "resolveTarget()?.id()", "attr.aria-expanded": "resolveTarget()?.open()" } }, providers: [SidebarStyle, { provide: PARENT_INSTANCE, useExisting: SidebarTrigger }], usesInheritance: true, ngImport: i0 });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarTrigger, decorators: [{
            type: Directive,
            args: [{
        ...
        }], propDecorators: { target: [{ type: i0.Input, args: [{ isSignal: true, alias: "target", required: false }] }] } });
...
class Sidebar extends BaseComponent {
     ...
     * @group Props
     */
    collapsible = input('icon', /* @ts-ignore */
     ...
     * @group Props
     */
    hideOnOutsideClick = input(true, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hideOnOutsideClick" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @group Props
     */
    iconWidth = input('3rem', /* @ts-ignore */
     ...
     * @group Props
     */
    openOnHover = input(false, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "openOnHover" }] : /* istanbul ignore next */ []));
    /**
     * Delay in ms before opening on hover.
     * @defaultValue 50
     * @group Props
     */
    hoverOpenDelay = input(50, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hoverOpenDelay" }] : /* istanbul ignore next */ []));
    /**
     * Delay in ms before closing on hover leave.
     * @defaultValue 100
     * @group Props
     */
    hoverCloseDelay = input(100, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hoverCloseDelay" }] : /* istanbul ignore next */ []));
    /**
     * Unique id used by [pSidebarTrigger] target lookup.
     * @group Props
     */
    id = input(uuid('p-sidebar-'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "id" }] : /* istanbul ignore next */ []));
    displayState = computed(() => (this.open() ? 'expanded' : 'collapsed'), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "displayState" }] : /* istanbul ignore next */ []));
    dataCollapsible = computed(() => (this.displayState() === 'collapsed' ? this.collapsible() : null), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "dataCollapsible" }] : /* istanbul ignore next */ []));
    dataOverlay = computed(() => (this.overlay() ? '' : null), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "dataOverlay" }] : /* istanbul ignore next */ []));
    _componentStyle = inject(SidebarStyle);
    hoverTimer = null;
    constructor() {
        super();
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: Sidebar, deps: [], target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.1.0", version: "22.0.5", type: Sidebar, isStandalone: true, selector: "p-sidebar", inputs: { open: { classPropertyName: "open", publicName: "open", isSignal: true, isRequired: false, transformFunction: null }, side: { classPropertyName: "side", publicName: "side", isSignal: true, isRequired: false, transformFunction: null }, variant: { classPropertyName: "variant", publicName: "variant", isSignal: true, isRequired: false, transformFunction: null }, collapsible: { classPropertyName: "collapsible", publicName: "collapsible", isSignal: true, isRequired: false, transformFunction: null }, overlay: { classPropertyName: "overlay", publicName: "overlay", isSignal: true, isRequired: false, transformFunction: null }, dismissable: { classPropertyName: "dismissable", publicName: "dismissable", isSignal: true, isRequired: false, transformFunction: null }, hideOnOutsideClick: { classPropertyName: "hideOnOutsideClick", publicName: "hideOnOutsideClick", isSignal: true, isRequired: false, transformFunction: null }, width: { classPropertyName: "width", publicName: "width", isSignal: true, isRequired: false, transformFunction: null }, iconWidth: { classPropertyName: "iconWidth", publicName: "iconWidth", isSignal: true, isRequired: false, transformFunction: null }, openOnHover: { classPropertyName: "openOnHover", publicName: "openOnHover", isSignal: true, isRequired: false, transformFunction: null }, hoverOpenDelay: { classPropertyName: "hoverOpenDelay", publicName: "hoverOpenDelay", isSignal: true, isRequired: false, transformFunction: null }, hoverCloseDelay: { classPropertyName: "hoverCloseDelay", publicName: "hoverCloseDelay", isSignal: true, isRequired: false, transformFunction: null }, id: { classPropertyName: "id", publicName: "id", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { open: "openChange" }, host: { listeners: { "pointerenter": "onPointerEnter($event)", "pointerleave": "onPointerLeave($event)", "keydown.escape": "onEscape()" }, properties: { "class": "cx('root')", "attr.data-side": "side()", "attr.data-variant": "variant()", "attr.data-collapsible": "dataCollapsible()", "attr.data-collapsible-mode": "collapsible()", "attr.data-overlay": "dataOverlay()", "attr.data-state": "displayState()", "style.--px-sidebar-width": "width()", "style.--px-sidebar-width-icon": "iconWidth()" } }, providers: [SidebarStyle, { provide: SIDEBAR_INSTANCE, useExisting: Sidebar }, { provide: PARENT_INSTANCE, useExisting: Sidebar }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `<ng-content />`, isInline: true, dependencies: [{ kind: "ngmodule", type: BindModule }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: Sidebar, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-sidebar',
                    standalone: true,
        ...
        }], ctorParameters: () => [], propDecorators: { open: [{ type: i0.Input, args: [{ isSignal: true, alias: "open", required: false }] }, { type: i0.Output, args: ["openChange"] }], side: [{ type: i0.Input, args: [{ isSignal: true, alias: "side", required: false }] }], variant: [{ type: i0.Input, args: [{ isSignal: true, alias: "variant", required: false }] }], collapsible: [{ type: i0.Input, args: [{ isSignal: true, alias: "collapsible", required: false }] }], overlay: [{ type: i0.Input, args: [{ isSignal: true, alias: "overlay", required: false }] }], dismissable: [{ type: i0.Input, args: [{ isSignal: true, alias: "dismissable", required: false }] }], hideOnOutsideClick: [{ type: i0.Input, args: [{ isSignal: true, alias: "hideOnOutsideClick", required: false }] }], width: [{ type: i0.Input, args: [{ isSignal: true, alias: "width", required: false }] }], iconWidth: [{ type: i0.Input, args: [{ isSignal: true, alias: "iconWidth", required: false }] }], openOnHover: [{ type: i0.Input, args: [{ isSignal: true, alias: "openOnHover", required: false }] }], hoverOpenDelay: [{ type: i0.Input, args: [{ isSignal: true, alias: "hoverOpenDelay", required: false }] }], hoverCloseDelay: [{ type: i0.Input, args: [{ isSignal: true, alias: "hoverCloseDelay", required: false }] }], id: [{ type: i0.Input, args: [{ isSignal: true, alias: "id", required: false }] }], onEscape: [{
                type: HostListener,
                args: ['keydown.escape']
            }] } });
const SIDEBAR_PARTS = [
...
class SidebarModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: SidebarModule, imports: [Sidebar, SidebarLayout,
            SidebarSpacer,
            SidebarAside,
            SidebarPanel,
            SidebarHeader,
            ...
            SidebarRail,
            SidebarBackdrop,
            SidebarMain], exports: [Sidebar, SidebarLayout,
            SidebarSpacer,
            SidebarAside,
            SidebarPanel,
            SidebarHeader,
            ...
            SidebarBackdrop,
            SidebarMain] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarModule, imports: [Sidebar, SidebarLayout,
            SidebarSpacer,
            SidebarAside,
            SidebarPanel,
            SidebarHeader,
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: SidebarModule, decorators: [{
            type: NgModule,
            args: [{
...
export { SIDEBAR_ASIDE_INSTANCE, SIDEBAR_CONTENT_INSTANCE, SIDEBAR_FOOTER_INSTANCE, SIDEBAR_GROUP_INSTANCE, SIDEBAR_HEADER_INSTANCE, SIDEBAR_INSTANCE, SIDEBAR_LAYOUT_INSTANCE, SIDEBAR_MENU_INSTANCE, SIDEBAR_MENU_ITEM_INSTANCE, SIDEBAR_MENU_SUB_INSTANCE, SIDEBAR_MENU_SUB_ITEM_INSTANCE, SIDEBAR_PANEL_INSTANCE, Sidebar, SidebarAside, SidebarBackdrop, SidebarClasses, SidebarContent, SidebarFooter, SidebarGroup, SidebarGroupAction, SidebarGroupContent, SidebarGroupLabel, SidebarHeader, SidebarLayout, SidebarMain, SidebarMenu, SidebarMenuAction, SidebarMenuBadge, SidebarMenuButton, SidebarMenuItem, SidebarMenuSub, SidebarMenuSubButton, SidebarMenuSubItem, SidebarModule, SidebarPanel, SidebarRail, SidebarSpacer, SidebarStyle, SidebarTrigger };
