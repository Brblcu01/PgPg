...
import { Injectable, InjectionToken, input, inject, forwardRef, computed, Component, contentChild, afterNextRender, ViewEncapsulation, ChangeDetectionStrategy, NgModule } from '@angular/core';
...
class MeterGroupStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroupStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroupStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroupStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class MeterGroupLabel extends BaseComponent {
    ...
    labelOrientation = input('horizontal', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "labelOrientation" }] : /* istanbul ignore next */ []));
    min = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "min" }] : /* istanbul ignore next */ []));
    max = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "max" }] : /* istanbul ignore next */ []));
    iconTemplate = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "iconTemplate" }] : /* istanbul ignore next */ []));
    ...
    getIconTemplateContext(labelItem) {
        return { $implicit: labelItem, icon: labelItem.icon };
    }
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroupLabel, deps: null, target: i0.ɵɵFactoryTarget.Component });
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.5", type: MeterGroupLabel, isStandalone: true, selector: "p-metergrouplabel", inputs: { value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: false, transformFunction: null }, labelPosition: { classPropertyName: "labelPosition", publicName: "labelPosition", isSignal: true, isRequired: false, transformFunction: null }, labelOrientation: { classPropertyName: "labelOrientation", publicName: "labelOrientation", isSignal: true, isRequired: false, transformFunction: null }, min: { classPropertyName: "min", publicName: "min", isSignal: true, isRequired: false, transformFunction: null }, max: { classPropertyName: "max", publicName: "max", isSignal: true, isRequired: false, transformFunction: null }, iconTemplate: { classPropertyName: "iconTemplate", publicName: "iconTemplate", isSignal: true, isRequired: false, transformFunction: null } }, usesInheritance: true, ngImport: i0, template: `
    ...
    `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "ngmodule", type: SharedModule }, { kind: "directive", type: Bind, selector: "[pBind]", inputs: ["pBind"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroupLabel, decorators: [{
            type: Component,
            args: [{
...
class MeterGroup extends BaseComponent {
     ...
     * @group Templates
     */
    labelTemplate = contentChild('label', { ...(ngDevMode ? { debugName: "labelTemplate" } : /* istanbul ignore next */ {}), descendants: false });
    /**
     ...
     * @group Templates
     */
    meterTemplate = contentChild('meter', { ...(ngDevMode ? { debugName: "meterTemplate" } : /* istanbul ignore next */ {}), descendants: false });
    /**
     * Custom end template.
    ...
    ...(ngDevMode ? [{ debugName: "totalPercent" }] : /* istanbul ignore next */ []));
    ...
    ...(ngDevMode ? [{ debugName: "percentages" }] : /* istanbul ignore next */ []));
    labelTemplateContext = computed(() => ({
        $implicit: this.value() ?? [],
        totalPercent: this.totalPercent(),
        percentages: this.percentages()
    }), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "labelTemplateContext" }] : /* istanbul ignore next */ []));
    meterItems = computed(() => this.value() ?? [], /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "meterItems" }] : /* istanbul ignore next */ []));
    isLabelStart = computed(() => this.labelPosition() === 'start', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "isLabelStart" }] : /* istanbul ignore next */ []));
    isLabelEnd = computed(() => this.labelPosition() === 'end', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "isLabelEnd" }] : /* istanbul ignore next */ []));
    showDefaultLabel = computed(() => !this.labelTemplate(), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "showDefaultLabel" }] : /* istanbul ignore next */ []));
    dataP = computed(() => this.cn({
    ...
    showDefaultMeter(meterItem) {
        return !this.meterTemplate() && (meterItem.value ?? 0) > 0;
    }
    getMeterTemplateContext(meterItem, index) {
        return {
            $implicit: meterItem,
            index,
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.5", type: MeterGroup, isStandalone: true, selector: "p-metergroup, p-meter-group", inputs: { value: { classPropertyName: "value", publicName: "value", isSignal: true, isRequired: false, transformFunction: null }, min: { classPropertyName: "min", publicName: "min", isSignal: true, isRequired: false, transformFunction: null }, max: { classPropertyName: "max", publicName: "max", isSignal: true, isRequired: false, transformFunction: null }, orientation: { classPropertyName: "orientation", publicName: "orientation", isSignal: true, isRequired: false, transformFunction: null }, labelPosition: { classPropertyName: "labelPosition", publicName: "labelPosition", isSignal: true, isRequired: false, transformFunction: null }, labelOrientation: { classPropertyName: "labelOrientation", publicName: "labelOrientation", isSignal: true, isRequired: false, transformFunction: null } }, host: { properties: { "attr.aria-valuemin": "min()", "attr.role": "\"meter\"", "attr.aria-valuemax": "max()", "attr.aria-valuenow": "totalPercent()", "attr.data-p": "dataP()", "class": "cn(cx('root'))" } }, providers: [MeterGroupStyle, { provide: METERGROUP_INSTANCE, useExisting: MeterGroup }, { provide: PARENT_INSTANCE, useExisting: MeterGroup }], queries: [{ propertyName: "labelTemplate", first: true, predicate: ["label"], isSignal: true }, { propertyName: "meterTemplate", first: true, predicate: ["meter"], isSignal: true }, { propertyName: "endTemplate", first: true, predicate: ["end"], isSignal: true }, { propertyName: "startTemplate", first: true, predicate: ["start"], isSignal: true }, { propertyName: "iconTemplate", first: true, predicate: ["icon"], isSignal: true }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `
        ...
        <div [class]="cx('meters')" [pBind]="ptm('meters')" [attr.data-p]="dataP()">
            @for (meterItem of meterItems(); track $index) {
    ...
    `, isInline: true, dependencies: [{ kind: "directive", type: NgTemplateOutlet, selector: "[ngTemplateOutlet]", inputs: ["ngTemplateOutletContext", "ngTemplateOutlet", "ngTemplateOutletInjector"] }, { kind: "component", type: MeterGroupLabel, selector: "p-metergrouplabel", inputs: ["value", "labelPosition", "labelOrientation", "min", "max", "iconTemplate"] }, { kind: "ngmodule", type: SharedModule }, { kind: "directive", type: Bind, selector: "[pBind]", inputs: ["pBind"] }], changeDetection: i0.ChangeDetectionStrategy.OnPush, encapsulation: i0.ViewEncapsulation.None });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: MeterGroup, decorators: [{
            type: Component,
            args: [{
