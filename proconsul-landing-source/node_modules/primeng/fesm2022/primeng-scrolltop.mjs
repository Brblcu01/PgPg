...
import { Injectable, InjectionToken, inject, input, numberAttribute, contentChild, computed, signal, afterEveryRender, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
class ScrollTopStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class ScrollTop extends BaseComponent {
     ...
     * @group Props
     */
    _icon = input(undefined, { ...(ngDevMode ? { debugName: "_icon" } : /* istanbul ignore next */ {}), alias: 'icon' });
    /**
    ...
    constructor() {
        ...
        const ref = afterEveryRender(() => {
            if (this.target() !== 'parent' || this.parentScrollListener) {
                ref.destroy();
                return;
            }
    ...
    bindParentScrollListener() {
        ...
        if (!parent)
            return;
        this.parentScrollListener = this.renderer.listen(parent, 'scroll', () => {
            this.checkVisibility(parent.scrollTop);
        });
    }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTop, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-scrolltop, p-scroll-top',
                    standalone: true,
                    imports: [NgTemplateOutlet, ChevronUp, ButtonDirective, SharedModule, MotionDirective],
                    template: `
        @if (render()) {
            <button
                type="button"
    ...
    `,
        ...
        }], ctorParameters: () => [], propDecorators: { styleClass: [{ type: i0.Input, args: [{ isSignal: true, alias: "styleClass", required: false }] }], style: [{ type: i0.Input, args: [{ isSignal: true, alias: "style", required: false }] }], target: [{ type: i0.Input, args: [{ isSignal: true, alias: "target", required: false }] }], threshold: [{ type: i0.Input, args: [{ isSignal: true, alias: "threshold", required: false }] }], _icon: [{ type: i0.Input, args: [{ isSignal: true, alias: "icon", required: false }] }], behavior: [{ type: i0.Input, args: [{ isSignal: true, alias: "behavior", required: false }] }], motionOptions: [{ type: i0.Input, args: [{ isSignal: true, alias: "motionOptions", required: false }] }], buttonAriaLabel: [{ type: i0.Input, args: [{ isSignal: true, alias: "buttonAriaLabel", required: false }] }], buttonProps: [{ type: i0.Input, args: [{ isSignal: true, alias: "buttonProps", required: false }] }], iconTemplate: [{ type: i0.ContentChild, args: ['icon', { ...{ descendants: false }, isSignal: true }] }] } });
class ScrollTopModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopModule, imports: [ScrollTop, SharedModule], exports: [ScrollTop, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopModule, imports: [ScrollTop, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ScrollTopModule, decorators: [{
            type: NgModule,
            args: [{
