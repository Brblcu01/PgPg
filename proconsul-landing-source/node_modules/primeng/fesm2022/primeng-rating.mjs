...
import { Injectable, InjectionToken, forwardRef, inject, input, booleanAttribute, numberAttribute, output, contentChild, signal, computed, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
const classes = {
    ...
    onIcon: ({ instance }) => ['p-rating-on-icon', { 'p-invalid': instance.invalid() }],
    offIcon: ({ instance }) => ['p-rating-off-icon', { 'p-invalid': instance.invalid() }]
};
class RatingStyle extends BaseStyle {
    name = 'rating';
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class Rating extends BaseEditableHolder {
    ...
    /**
     * When present, selecting half stars is allowed.
     * @group Props
     */
    ...
    nameattr = signal(undefined, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "nameattr" }] : /* istanbul ignore next */ []));
    hovering = signal(false, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hovering" }] : /* istanbul ignore next */ []));
    hoveringValue = signal(0, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "hoveringValue" }] : /* istanbul ignore next */ []));
    ...
    attrReadonly = computed(() => (this.readonly() ? '' : undefined), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "attrReadonly" }] : /* istanbul ignore next */ []));
    attrDisabled = computed(() => (this.$disabled() ? '' : undefined), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "attrDisabled" }] : /* istanbul ignore next */ []));
    attrName = computed(() => this.name() || this.nameattr() + '_name', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "attrName" }] : /* istanbul ignore next */ []));
    dataP = computed(() => this.cn({
        readonly: this.readonly(),
        disabled: this.$disabled()
    }), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "dataP" }] : /* istanbul ignore next */ []));
    isCustomIcon = computed(() => !!(this.onIconTemplate() || this.offIconTemplate()), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "isCustomIcon" }] : /* istanbul ignore next */ []));
    activeValue = computed(() => (this.hovering() ? this.hoveringValue() : (this.value() ?? 0)), /* @ts-ignore */
    ...
    resolvePointerValue(event, star) {
        if (this.allowHalf()) {
            ...
            return isHalf ? star + 0.5 : star + 1;
        }
        return star + 1;
    }
    onOptionClick(event, star) {
        ...
        const value = this.allowHalf() ? this.resolvePointerValue(event, star - 1) : star;
    ...
    onPointerMove(event, star) {
        if (!this.readonly() && !this.$disabled()) {
            this.hovering.set(true);
            const value = this.resolvePointerValue(event, star);
            this.hoveringValue.set(value);
        }
    }
    onPointerEnter() {
        if (!this.readonly() && !this.$disabled()) {
    ...
    onInputBlur(event) {
        ...
        const host = event.currentTarget.closest('.p-rating');
    ...
    static ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "17.0.0", version: "22.0.5", type: Rating, isStandalone: true, selector: "p-rating", inputs: { readonly: { classPropertyName: "readonly", publicName: "readonly", isSignal: true, isRequired: false, transformFunction: null }, stars: { classPropertyName: "stars", publicName: "stars", isSignal: true, isRequired: false, transformFunction: null }, iconOnClass: { classPropertyName: "iconOnClass", publicName: "iconOnClass", isSignal: true, isRequired: false, transformFunction: null }, iconOnStyle: { classPropertyName: "iconOnStyle", publicName: "iconOnStyle", isSignal: true, isRequired: false, transformFunction: null }, iconOffClass: { classPropertyName: "iconOffClass", publicName: "iconOffClass", isSignal: true, isRequired: false, transformFunction: null }, iconOffStyle: { classPropertyName: "iconOffStyle", publicName: "iconOffStyle", isSignal: true, isRequired: false, transformFunction: null }, autofocus: { classPropertyName: "autofocus", publicName: "autofocus", isSignal: true, isRequired: false, transformFunction: null }, allowHalf: { classPropertyName: "allowHalf", publicName: "allowHalf", isSignal: true, isRequired: false, transformFunction: null }, orientation: { classPropertyName: "orientation", publicName: "orientation", isSignal: true, isRequired: false, transformFunction: null } }, outputs: { onRate: "onRate", onFocus: "onFocus", onBlur: "onBlur" }, host: { listeners: { "pointerenter": "onPointerEnter()", "pointerleave": "onPointerLeave()" }, properties: { "class": "cx('root')", "attr.data-p": "dataP()", "attr.data-orientation": "orientation()" } }, providers: [RATING_VALUE_ACCESSOR, RatingStyle, { provide: RATING_INSTANCE, useExisting: Rating }, { provide: PARENT_INSTANCE, useExisting: Rating }], queries: [{ propertyName: "onIconTemplate", first: true, predicate: ["onicon"], isSignal: true }, { propertyName: "offIconTemplate", first: true, predicate: ["officon"], isSignal: true }], usesInheritance: true, hostDirectives: [{ directive: i1.Bind }], ngImport: i0, template: `
        @for (star of starsArray; track star; let i = $index) {
            ...
            >
                <span class="p-hidden-accessible" [attr.data-p-hidden-accessible]="true" [pBind]="ptm('hiddenOptionInputContainer')">
                    @if (allowHalf()) {
                        <input
                            ...
                            [attr.aria-label]="starAriaLabel(star + 0.5)"
                            (focus)="onInputFocus($event, star + 0.5)"
                            (blur)="onInputBlur($event)"
                            (change)="onChange($event, star + 0.5)"
                ...
                @if (onIconTemplate()) {
                    <span [class]="cx('onIcon')" [style]="iconOnStyle()" [attr.data-orientation]="orientation()" [pBind]="ptm('onIcon')">
                        <ng-container *ngTemplateOutlet="onIconTemplate(); context: getOnIconContext(star)"></ng-container>
                    </span>
                } @else if (iconOnClass()) {
                    <span [class]="cn(cx('onIcon'), iconOnClass())" [style]="iconOnStyle()" [attr.data-orientation]="orientation()" [pBind]="ptm('onIcon')"></span>
                } @else {
                    <svg data-p-icon="star-fill" [style]="iconOnStyle()" [class]="cx('onIcon')" [attr.data-orientation]="orientation()" [pBind]="ptm('onIcon')" />
                }
            </div>
        }
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: Rating, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-rating',
                    imports: [NgTemplateOutlet, AutoFocus, StarFill, Star, SharedModule, BindModule],
                    standalone: true,
                    template: `
        @for (star of starsArray; track star; let i = $index) {
            <div
    ...
    `,
        ...
        }], propDecorators: { readonly: [{ type: i0.Input, args: [{ isSignal: true, alias: "readonly", required: false }] }], stars: [{ type: i0.Input, args: [{ isSignal: true, alias: "stars", required: false }] }], iconOnClass: [{ type: i0.Input, args: [{ isSignal: true, alias: "iconOnClass", required: false }] }], iconOnStyle: [{ type: i0.Input, args: [{ isSignal: true, alias: "iconOnStyle", required: false }] }], iconOffClass: [{ type: i0.Input, args: [{ isSignal: true, alias: "iconOffClass", required: false }] }], iconOffStyle: [{ type: i0.Input, args: [{ isSignal: true, alias: "iconOffStyle", required: false }] }], autofocus: [{ type: i0.Input, args: [{ isSignal: true, alias: "autofocus", required: false }] }], allowHalf: [{ type: i0.Input, args: [{ isSignal: true, alias: "allowHalf", required: false }] }], orientation: [{ type: i0.Input, args: [{ isSignal: true, alias: "orientation", required: false }] }], onRate: [{ type: i0.Output, args: ["onRate"] }], onFocus: [{ type: i0.Output, args: ["onFocus"] }], onBlur: [{ type: i0.Output, args: ["onBlur"] }], onIconTemplate: [{ type: i0.ContentChild, args: ['onicon', { ...{ descendants: false }, isSignal: true }] }], offIconTemplate: [{ type: i0.ContentChild, args: ['officon', { ...{ descendants: false }, isSignal: true }] }] } });
class RatingModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: RatingModule, imports: [Rating, SharedModule], exports: [Rating, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingModule, imports: [Rating, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: RatingModule, decorators: [{
            type: NgModule,
            args: [{
