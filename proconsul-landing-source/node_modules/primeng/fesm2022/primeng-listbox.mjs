...
import { FilterService, Header, Footer, SharedModule } from 'primeng/api';
...
const style = /*css*/ `
    ...
    /* Checkbox selection: the checkbox already conveys selection, so a selected
       option is not given a highlighted background — only the checkbox marks it.
       Text color/weight are kept; focus and hover fall back to the normal option
       feedback so keyboard and pointer states still read clearly. */
    .p-listbox.p-listbox-checkbox .p-listbox-list .p-listbox-option.p-listbox-option-selected {
        background: transparent;
    }

    .p-listbox.p-listbox-checkbox:not(.p-disabled) .p-listbox-list .p-listbox-option.p-listbox-option-selected.p-focus {
        background: dt('listbox.option.focus.background');
        color: dt('listbox.option.focus.color');
    }

    .p-listbox.p-listbox-checkbox:not(.p-disabled) .p-listbox-list .p-listbox-option.p-listbox-option-selected:not(.p-disabled):hover {
        background: dt('listbox.option.focus.background');
        color: dt('listbox.option.focus.color');
    }
`;
const classes = {
    root: ({ instance }) => [
        'p-listbox p-component',
        {
            ...
            'p-listbox-checkbox': instance.showOptionCheckbox(),
...
class ListBoxStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListBoxStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListBoxStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListBoxStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
(function (ListboxClasses) {
     ...
     */
    ListboxClasses["dragPreview"] = "p-listbox-drag-preview";
    /**
     * Class name of the overflow row in the multi-selection drag preview
     */
    ListboxClasses["dragPreviewMore"] = "p-listbox-drag-preview-more";
...
class Listbox extends BaseEditableHolder {
     ...
     */
    scrollerStyle = computed(() => ({ height: this.scrollHeight() === 'flex' ? '100%' : this.scrollHeight() }), /* @ts-ignore */
     ...
     */
    dragPreviewOptions() {
        return this.visibleOptions().filter((option) => !this.isOptionGroup(option) && this.isSelected(option));
    }
    /** True when dragging this option effectively drags the whole multi-selection. */
    isMultiDrag(option) {
        return this.isSelected(option) && this.dragPreviewOptions().length > 1;
    }
    getDragPreviewTemplateContext(option) {
        return {
            $implicit: option,
            index: this.visibleOptions().indexOf(option),
            selected: true,
            disabled: this.isOptionDisabled(option)
        };
    }
...
class ListboxModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListboxModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: ListboxModule, imports: [Listbox, SharedModule], exports: [Listbox, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListboxModule, imports: [Listbox, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ListboxModule, decorators: [{
            type: NgModule,
            args: [{
