...
class BaseInput extends BaseEditableHolder {
     ...
     * @group Props
     */
    inputSize = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "inputSize" }] : /* istanbul ignore next */ []));
    /**
