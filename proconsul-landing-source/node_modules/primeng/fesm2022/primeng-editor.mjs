...
import { Injectable, InjectionToken, forwardRef, inject, input, output, contentChild, computed, effect, afterNextRender, ViewEncapsulation, ChangeDetectionStrategy, Component, NgModule } from '@angular/core';
...
class EditorStyle extends BaseStyle {
    ...
    style = style;
    classes = classes;
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorStyle, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorStyle });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorStyle, decorators: [{
            type: Injectable
        }] });
/**
 *
...
class Editor extends BaseEditableHolder {
     ...
     * @group Props
     */
    formats = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "formats" }] : /* istanbul ignore next */ []));
    /**
     * Modules configuration of Editor, see [here](https://quilljs.com/docs/modules/) for available options.
     * @group Props
     */
    modules = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "modules" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @group Props
     */
    bounds = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "bounds" }] : /* istanbul ignore next */ []));
    /**
     * DOM Element or a CSS selector for a DOM Element, specifying which container has the scrollbars (i.e. overflow-y: auto), if is has been changed from the default ql-editor with custom CSS. Necessary to fix scroll jumping bugs when Quill is set to auto grow its height, and another ancestor container is responsible from the scrolling..
     * @group Props
     */
    scrollingContainer = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "scrollingContainer" }] : /* istanbul ignore next */ []));
    /**
     * Shortcut for debug. Note debug is a static method and will affect other instances of Quill editors on the page. Only warning and error messages are enabled by default.
     * @group Props
     */
    debug = input(/* @ts-ignore */
    ...(ngDevMode ? [undefined, { debugName: "debug" }] : /* istanbul ignore next */ []));
    /**
     ...
     * @group Emits
     */
    onEditorInit = output({ alias: 'onInit' });
    /**
     ...
     */
    onBlur = output();
    toolbar = contentChild(Header, { ...(ngDevMode ? { debugName: "toolbar" } : /* istanbul ignore next */ {}), descendants: false });
    /**
     * Custom item template.
     * @group Templates
     */
    headerTemplate = contentChild('header', { ...(ngDevMode ? { debugName: "headerTemplate" } : /* istanbul ignore next */ {}), descendants: false });
    $hasCustomToolbar = computed(() => !!this.toolbar() || !!this.headerTemplate(), /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "$hasCustomToolbar" }] : /* istanbul ignore next */ []));
    value;
    delayedCommand = null;
    quill;
    dynamicQuill;
    ...
    writeControlValue(value) {
        if (this.quill && this.value === value) {
            return;
        }
        this.value = value;
        if (this.quill) {
    ...
    createQuillEditor() {
        // The Quill module is imported asynchronously; if the component was destroyed before the
        // import resolved, bail so we don't build Quill and emit (onEditorInit etc.) after destroy.
        if (this._destroyed)
            return;
        this.initQuillElements();
...
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: Editor, decorators: [{
            type: Component,
            args: [{
                    selector: 'p-editor',
                    standalone: true,
    ...
    `,
        ...
        }], ctorParameters: () => [], propDecorators: { style: [{ type: i0.Input, args: [{ isSignal: true, alias: "style", required: false }] }], placeholder: [{ type: i0.Input, args: [{ isSignal: true, alias: "placeholder", required: false }] }], formats: [{ type: i0.Input, args: [{ isSignal: true, alias: "formats", required: false }] }], modules: [{ type: i0.Input, args: [{ isSignal: true, alias: "modules", required: false }] }], bounds: [{ type: i0.Input, args: [{ isSignal: true, alias: "bounds", required: false }] }], scrollingContainer: [{ type: i0.Input, args: [{ isSignal: true, alias: "scrollingContainer", required: false }] }], debug: [{ type: i0.Input, args: [{ isSignal: true, alias: "debug", required: false }] }], readonly: [{ type: i0.Input, args: [{ isSignal: true, alias: "readonly", required: false }] }], onEditorInit: [{ type: i0.Output, args: ["onInit"] }], onTextChange: [{ type: i0.Output, args: ["onTextChange"] }], onSelectionChange: [{ type: i0.Output, args: ["onSelectionChange"] }], onEditorChange: [{ type: i0.Output, args: ["onEditorChange"] }], onFocus: [{ type: i0.Output, args: ["onFocus"] }], onBlur: [{ type: i0.Output, args: ["onBlur"] }], toolbar: [{ type: i0.ContentChild, args: [i0.forwardRef(() => Header), { ...{ descendants: false }, isSignal: true }] }], headerTemplate: [{ type: i0.ContentChild, args: ['header', { ...{ descendants: false }, isSignal: true }] }] } });
class EditorModule {
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorModule, deps: [], target: i0.ɵɵFactoryTarget.NgModule });
    static ɵmod = i0.ɵɵngDeclareNgModule({ minVersion: "14.0.0", version: "22.0.5", ngImport: i0, type: EditorModule, imports: [Editor, SharedModule], exports: [Editor, SharedModule] });
    static ɵinj = i0.ɵɵngDeclareInjector({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorModule, imports: [Editor, SharedModule, SharedModule] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: EditorModule, decorators: [{
            type: NgModule,
            args: [{
