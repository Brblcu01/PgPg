...
class ThemeProvider {
    ...
    csp = signal({ nonce: undefined }, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "csp" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ThemeProvider, deps: [], target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ThemeProvider, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: ThemeProvider, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }], ctorParameters: () => [] });

class PrimeNG extends ThemeProvider {
    ripple = signal(false, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "ripple" }] : /* istanbul ignore next */ []));
    platformId = inject(PLATFORM_ID);
    inputVariant = signal(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "inputVariant" }] : /* istanbul ignore next */ []));
    _verified = signal(null, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "_verified" }] : /* istanbul ignore next */ []));
    verified = this._verified.asReadonly();
    _setVerified(value) {
        this._verified.set(value);
    }
    overlayAppendTo = signal('self', /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "overlayAppendTo" }] : /* istanbul ignore next */ []));
    overlayOptions = {};
    csp = signal({ nonce: undefined }, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "csp" }] : /* istanbul ignore next */ []));
    unstyled = signal(undefined, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "unstyled" }] : /* istanbul ignore next */ []));
    pt = signal(undefined, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "pt" }] : /* istanbul ignore next */ []));
    ptOptions = signal(undefined, /* @ts-ignore */
    ...(ngDevMode ? [{ debugName: "ptOptions" }] : /* istanbul ignore next */ []));
    ...
    static ɵfac = i0.ɵɵngDeclareFactory({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: PrimeNG, deps: null, target: i0.ɵɵFactoryTarget.Injectable });
    static ɵprov = i0.ɵɵngDeclareInjectable({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: PrimeNG, providedIn: 'root' });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "22.0.5", ngImport: i0, type: PrimeNG, decorators: [{
            type: Injectable,
            args: [{ providedIn: 'root' }]
        }] });
...
function providePrimeNG(...features) {
    ...
    const initializer = provideAppInitializer(() => {
        ...
        if (license)
            registerLicense({ primeui: license });
