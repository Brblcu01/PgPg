...
declare const DATA_ATTRS: readonly ["data-enter-phase", "data-enter-from", "data-enter-to", "data-enter-active", "data-leave-phase", "data-leave-from", "data-leave-to", "data-leave-active"];
/**
 ...
 */
declare function resolveCSSVarName(prefix: string | undefined, name: string): string;
/**
 ...
 */
declare function setDimensionVariables(element: HTMLElement, options: MotionOptions, value: string | {
    height: string;
    width: string;
}): void;
/**
 ...
 * @param options - The motion options.
 */
declare function setAutoDimensionVariables(element: HTMLElement, options: MotionOptions): void;
/**
...
export { ANIMATION, type ClassNameOptions, DATA_ATTRS, DEFAULT_MOTION_OPTIONS, type MotionClassNames, type MotionClassNamesWithPhase, type MotionDuration, type MotionEvent, type MotionHooks, type MotionHooksWithPhase, type MotionInstance, type MotionMetadata, type MotionOptions, type MotionPhase, type MotionStage, type MotionState, type MotionType, TRANSITION, createMotion, getMotionHooks, getMotionMetadata, mergeOptions, removeMotionPhase, removeMotionState, resolveCSSVarName, resolveClassNames, resolveDuration, setAutoDimensionVariables, setDimensionVariables, setMotionPhase, setMotionState, shouldSkipMotion };
