...
var p = (t, n) => {
  for (var e in n || (n = {})) q2.call(n, e) && D(t, e, n[e]);
  if (T2) for (var e of T2(n)) V.call(n, e) && D(t, e, n[e]);
  return t;
};
...
function A(t, n) {
  ...
  }, [m, i] = o(v), [M2, f] = o(E), r = Math.max(...i.map((l, c) => l + m[c])), u = Math.max(...f.map((l, c) => l + M2[c])), a, s2 = 0, d = 0;
...
function tt(t, n) {
  ...
  let e = {}, o = false, m = {}, i = null, M2 = {}, f = (a) => {
    ...
    i == null || i();
    let { onBefore: s2, onStart: d, onAfter: l, onCancelled: c } = M2[a] || {}, h = { element: t };
    if (o) {
      s2 == null || s2(h), d == null || d(h), l == null || l(h);
      return;
    }
    let { from: g, active: y2, to: P2 } = m[a] || {};
    return S(t, e.autoHeight, e.autoWidth), s2 == null || s2(h), W(t, g), W(t, y2), t.offsetHeight, P(t, g), W(t, P2), d == null || d(h), new Promise((b) => {
...
var Dialog = class _Dialog extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    contentQueries: function Dialog_ContentQueries(rf, ctx, dirIndex) {
      if (rf & 1) {
        ɵɵcontentQuery(dirIndex, _c02, 4)(dirIndex, _c1, 4)(dirIndex, _c2, 4)(dirIndex, _c3, 4)(dirIndex, _c4, 4)(dirIndex, _c5, 4)(dirIndex, _c6, 4)(dirIndex, PrimeTemplate, 4);
      }
      if (rf & 2) {
        let _t;
